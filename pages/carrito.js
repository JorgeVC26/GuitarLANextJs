        ...
        <main className='contenedor'>
            ...
            <div className={styles.contenido}>
                <div className={styles.carrito}>
                    ...
                    {/* Mostrando en carrito de compras */}
                    {carrito.length === 0 ? 'Carrito Vacío' : (  /* Comprobando que el carrito no este vacio */
                        carrito.map(producto => (
                            <div key={producto.id} className={styles.producto}>
                                <div>
                                {/* Agregando la informacion que queremos mostrar en carrito  */}
